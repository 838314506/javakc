...
<html>
	<head>
		...
		$(function(){
			...
			alert(orgParentId);
			var parentName = treeObj.getNodeByParam("id",orgParentId, null);
			$('#orgSel').val(parentName.name);
	...
	<body>
		<div class="wrapper wrapper-content animated fadeInRight">
			...
			<div class="ibox float-e-margins">
				...
				<input type="hidden" name="orgParentId" id="orgParentId" value="${entity.orgParentId }"/>
				<input type="hidden" name="orgId" value="${entity.orgId }"/>
                    <fieldset>
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-sm-4">
                              <input id="orgSel" type="text" name="pname" value="" class="form-control" readonly/>
                           </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-sm-4">
                              <input type="text" name="orgName" value="${entity.orgName }" class="form-control"/>
                           </div>
                        </div>
                        <div class="form-group">
							<label for="disabledSelect" class="col-sm-2 control-label">是否展开</label>
							<div class="col-sm-2">
								关闭<input type="checkbox" name="orgOpen" value="0" ${entity.orgOpen==0?"checked":"" }/>
							</div>
							<div class="col-sm-2">
								展开<input type="checkbox" name="orgOpen" value="1" ${entity.orgOpen==1?"checked":"" }/>
							</div>
                        </div>
                        <div class="form-group">
							<label for="disabledSelect" class="col-sm-2 control-label">节点等级</label>
							<div class="col-sm-4">
								<input type="text" name="orgLevel" value="${entity.orgLevel }" class="form-control"/>
							</div>
                        </div>
                        <div class="form-group">
							<label for="disabledSelect" class="col-sm-2 control-label">节点排序</label>
							<div class="col-sm-4">
								<input type="text" name="orgOrder" value="${entity.orgOrder }" class="form-control"/>
							</div>
                        </div>
                    </fieldset>
                    <fieldset>
